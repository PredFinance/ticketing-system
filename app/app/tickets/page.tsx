...
import { Ticket, Plus, Search, MessageSquare, Clock, User, Calendar, Eye } from "lucide-react"
          ...
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-full sm:w-40 h-10 rounded-lg border-gray-200">
